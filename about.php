...
<head>
    <title>COLEGIO PARTENON PREPARATORIA Y BACHILLERATO</title>
    <meta charset="utf-8">
  ...
  <body>
    <div class="bg-top navbar-light">
      <div class="container">
        <div class="row no-gutters d-flex align-items-left align-items-stretch">
          <div class="col-md-4 d-flex align-items-left py-4">
            <a class="navbar-brand" href="index.html">COLEGIO PARTENÓN <span>PREPARATORIA Y BACHILLERATO</span></a>
          </div>
          <div class="col-lg-8 d-block">
            <div class="row d-flex">
              <div class="col-md d-flex topper align-items-right align-items-stretch py-md-4">
                <div class="icon d-flex justify-content-right align-items-right"><span class="icon-paper-plane"></span></div>
                <div class="text">
                  <span>Email</span>
                  <span>colegiopartenon@hotmail.com</span>
                </div>
              </div>
              <div class="col-md d-flex topper align-items-right align-items-stretch py-md-4">
                ...
                <div class="text">
                  <span>Teléfonos</span>
                  <span>55 6381 7294</span>
                  <span>55 6381 7295</span>
                </div>
              </div>
              <div class="col-md topper d-flex align-items-center justify-content-end">
                <p class="mb-0">
                  <a href="SESION.html" class="btn py-2 px-3 btn-primary d-flex align-items-center justify-content-center">
      ...
      <div class="container d-flex align-items-center px-4">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active"><a href="about.php" class="nav-link">Acerca</a></li>
            <li class="nav-item"><a href="blog.php" class="nav-link">Bachillerato</a></li>
            <li class="nav-item"><a href="teacher.php" class="nav-link">Preparatoria</a></li>
            <li class="nav-item"><a href="https://quimicapartenon.wixsite.com/quimicacp" class="nav-link">MATERIAS</a></li>
